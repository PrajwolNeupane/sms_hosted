  ...
  return (
    <div className="flex flex-col w-full p-10 ">
      ...
      <div className="flex felx-row gap-3 p-5 bg-white border border-gray-300 rounded-md ">
        ...
        <div>
          <h5 className="text-primary font-medium text-xl">Student Name </h5>
          <h5 className="text-primary font-medium ">Class : 10 mary</h5>
          <h5 className="text-primary font-medium ">Id: 3223</h5>
        </div>
      </div>
